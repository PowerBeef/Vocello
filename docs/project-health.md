...
- Swift tests: 661 cases in 89 files
- Python tests: 1354 cases in 112 files
- Required-step assurance: 96 steps across 21 workflows, all covered by forced-failure fixtures
