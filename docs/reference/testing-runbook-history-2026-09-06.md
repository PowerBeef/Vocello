...
owner: release-qa
reviewed: 2026-09-06
summary: Preserved pre-cleanup docs/reference/testing-runbook.md; historical instructions only, current work uses the original path.
contentDigest: sha256:316ba3fed7dffae2b58e5008810f293615964d75fb1a8c411ee6713daae12b50
---
> **Historical snapshot, archived 2026-09-06.** Preserved pre-cleanup text, not current instructions.
> For current work use [testing-runbook.md](testing-runbook.md). Old run commands do not authorize resume.
