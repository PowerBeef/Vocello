...
| Item | Status | Title | Evidence |
| --- | --- | --- | --- |
| `IUI-1` | in-flight | Instrument: scripts/ui_test.sh ios perf frame-health harness | — |
