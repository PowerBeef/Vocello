...
- Swift tests: 662 cases in 89 files
- Python tests: 1385 cases in 117 files
...
- Evidence routing: 896/896 critical paths explicit; 0 use repository-other fallback
...
| memory-policy | backend-platform | 6 | 6 / 55 | macos-memory-qualification: stale, ios-memory-qualification: stale |
| model-delivery | backend-platform | 17 | 7 / 73 | external promotion: macos-model-download-lifecycle, ios-model-download-lifecycle |
