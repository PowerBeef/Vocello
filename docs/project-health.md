...
- Swift tests: 813 cases in 110 files
- Python tests: 1726 cases in 129 files
...
- Evidence routing: 968/968 critical paths explicit; 0 use repository-other fallback
...
| memory-policy | backend-platform | 6 | 10 / 85 | macos-memory-qualification: stale, ios-memory-qualification: stale |
| model-delivery | backend-platform | 17 | 11 / 103 | external promotion: macos-model-download-lifecycle, ios-model-download-lifecycle |
