...
/*
  ...
  - RTF bars: benchmarks/runs/ui-generation/macos-xcui-benchmark-20260914-055243-dfa37630.json
...
*/
const MODES = [
  { name: "Built-in Voice", tone: "var(--mode-custom)", takes: [0.71, 0.61, 0.57] },
  { name: "Voice Design", tone: "var(--mode-design)", takes: [0.67, 0.56, 0.53] },
  { name: "Voice Cloning", tone: "var(--mode-clone)", takes: [0.74, 0.62, 0.55] },
];
