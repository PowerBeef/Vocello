...
generation measurably faster while the app is on screen, and overhauls model downloads.
Everything still runs locally on Apple Silicon via MLX; no audio leaves the Mac unless you
export it.
