...
Every number below comes from a tracked, privacy-safe benchmark record in this repository and was measured on the support-floor tier, a Mac mini M2 with 8 GB, the canonical benchmark host until 2026-09-22. The chart below comes from record `379db820`, measured with a Vocello 3.0 build from source. Canonical records now come from a Mac mini M6 with 16 GB and start a new series; M2 and M6 records are never compared.
