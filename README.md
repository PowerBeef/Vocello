...
<picture>
  ...
  <img alt="Grouped bar chart: warm real-time factor by script length, lower is faster: Built-in Voice 0.60 to 0.90, Voice Design 0.57 to 0.83, Voice Cloning 0.59 to 0.96. Every bar sits below the real-time line at 1.0." src="docs/charts/rtf-by-mode-light.svg">
</picture>
<!-- rtf-chart:end -->
