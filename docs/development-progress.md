...
update-models`). In flight: PA-28 (a failed download range retries alone instead of discarding
the file; PA-29 measures the background fan-out afterwards). Next: PA-16 (tokenizer sliding windows, consent-bound
