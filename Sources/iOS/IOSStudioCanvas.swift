...
struct IOSStudioCanvas<SetupChips: View>: View {
    ...
    // Honor Reduce Motion for the generating waveform (.claude/rules/native.md iOS UI conventions);
...
// MARK: - iOS presentation of the shared Studio payloads (StudioGenerationItems.swift)

extension IOSStudioInlinePlayerItem {
...
extension IOSStudioCadenceNotice {
