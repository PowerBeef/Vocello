...
- The primary CTA is Vocello 2.3.0 for macOS 26 and Apple Silicon (stable). QwenVoice 1.2.3 remains the stable fallback for macOS 15, and the iPhone app is a public TestFlight beta with its own visible entry point.
