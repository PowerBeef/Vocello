...
reviewed: 2026-09-06
summary: Preserved pre-cleanup docs/development-progress.md; historical instructions only, current work uses the original path.
contentDigest: sha256:659bd6a1a77b03cf6681e4bcab5a0a874ee6a964a8f10ac20a4973f1e0fb471f
---
> **Historical snapshot, archived 2026-09-06.** Preserved pre-cleanup text, not current instructions.
> For current work use [development-progress.md](development-progress.md). Old run commands do not authorize resume.
