...
4. **Stage 3 — quality harness (folds phase 12, then 13)** — in progress 2026-07-26,
   ...
   **shipped** — `scripts/clone_speaker_similarity.py` (revision-pinned SpeechBrain ECAPA
   ...
   self-test gate; never a CI/packaging gate). Remaining: fold lane evidence into
   standard/canonical report emission (bench/lang-bench call sites; long-form needs
   segment-verdict threading), optional advisory MOS-proxy column, then benchmark/history
   v3 once plan/session/quality identities stabilize.
