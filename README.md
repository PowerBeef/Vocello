...
<picture>
  ...
  <img alt="Grouped bar chart: warm real-time factor by script length, lower is faster: Built-in Voice 0.58 to 0.69, Voice Design 0.53 to 0.71, Voice Cloning 0.55 to 0.82. Every bar sits below the real-time line at 1.0." src="docs/charts/rtf-by-mode-light.svg">
</picture>
<!-- rtf-chart:end -->
