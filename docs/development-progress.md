...
4. **Stage 3 — quality harness (folds phase 12, then 13)** — in progress 2026-07-26:
   ...
   shipping path). Remaining: standard/canonical depth folding (prosody/ASR/delivery
   gates), the dev-lane speaker-similarity gate for clone fidelity, optional advisory
   MOS-proxy column; then benchmark/history v3 once identities stabilize.
