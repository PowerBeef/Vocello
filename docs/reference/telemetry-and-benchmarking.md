...
- [`docs/reference/agent-rules/native.md`](agent-rules/native.md) — telemetry summary + engine invariants (bounded measured event delivery, typed cancellation, prewarm reentrancy, per-tier memory).
