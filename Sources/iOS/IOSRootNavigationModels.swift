...
enum IOSInterfaceText {
    ...
    static var qualityUnreadable: String {
        String(localized: "vocello.ui.qualityUnreadable", defaultValue: "Reference audio could not be read.",
    ...
    static var qualityIntro: String {
        String(localized: "vocello.ui.qualityIntro", defaultValue: "Voice cloning works best with 10–20 seconds of clean speech.",
               comment: "iOS display-only qualityIntro; preserve model IDs, prompt text and warning policy.")
    }
    static var qualityHard: String {
        String(localized: "vocello.ui.qualityHard", defaultValue: "Pick a clip that is 60 seconds or shorter to use it for cloning.",
               comment: "iOS display-only qualityHard; preserve model IDs, prompt text and warning policy.")
    }
    static var qualitySoft: String {
        String(localized: "vocello.ui.qualitySoft", defaultValue: "Clones from references outside this range still work, but may sound less consistent.",
    ...
    static func deleteAllHistory(_ count: Int) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.deleteAllHistory", defaultValue: "This permanently deletes all %1$lld history entries and their audio files.",
    ...
    static func clearAllHistory(_ count: Int) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.clearAllHistory", defaultValue: "This removes all %1$lld history entries. The generated audio files stay on the device.",
    ...
    static func queuedTakes(_ count: Int) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.queuedTakes", defaultValue: "%1$lld takes remain safely queued and available to retry or export.",
    ...
    static func segmentCount(_ count: Int) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.segmentCount", defaultValue: "%1$lld segments",
    ...
    static func pinSeed(_ seed: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.pinSeed", defaultValue: "Pin seed %1$@ for new takes",
    ...
    static func voiceBank(_ delivery: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.voiceBank", defaultValue: "Voice bank · %1$@",
    ...
    static func deletingVoice(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.deletingVoice", defaultValue: "Deleting %1$@",
    ...
    static func actionsForVoice(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.actionsForVoice", defaultValue: "Actions for %1$@",
    ...
    static func deleteVoicePermanent(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.deleteVoicePermanent", defaultValue: "Delete \"%1$@\" from this iPhone? This cannot be undone.",
    ...
    static func deleteVoiceBase(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.deleteVoiceBase", defaultValue: "Delete \"%1$@\"? Its voice-bank variants will remain as individual saved voices.",
    ...
    static func deleteVoiceVariant(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.deleteVoiceVariant", defaultValue: "Delete \"%1$@\"? The rest of this voice bank will remain available.",
    ...
    static func duplicateVoice(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.duplicateVoice", defaultValue: "A saved voice named %1$@ already exists. Choose another name.",
    ...
    static func savedNamedVoice(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.savedNamedVoice", defaultValue: "Saved “%1$@”",
    ...
    static func tooManySegments(_ count: Int, maximum: Int) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.tooManySegments", defaultValue: "This script plans %1$lld segments; the maximum is %2$lld. Split the text and try again.",
    ...
    static func transcriptLoadFailed(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.transcriptLoadFailed", defaultValue: "Couldn’t load the saved transcript for \"%1$@\". Cloning can still use the audio.",
    ...
    static func justNowMode(_ mode: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.justNowMode", defaultValue: "Just now · %1$@",
    ...
    static func languageAuto(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.languageAuto", defaultValue: "%1$@ (Auto)",
    ...
    static func languagePath(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.languagePath", defaultValue: "Use Qwen3’s %1$@ path.",
    ...
    static func voiceBankDetail(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.voiceBankDetail", defaultValue: "%1$@ is a voice bank: the same voice with curated emotion references. Each delivery clones its measured reference clip.",
    ...
    static func freesStorage(_ size: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.freesStorage", defaultValue: "Frees %1$@. You can reinstall later from Settings.",
    ...
    static func segmentChoice(_ number: Int, text: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.segmentChoice", defaultValue: "Segment %1$lld: %2$@",
    ...
    static var moreActions: String {
        String(localized: "vocello.ui.moreActions", defaultValue: "More actions",
    ...
    static var playbackPosition: String {
        String(localized: "vocello.ui.playbackPosition", defaultValue: "Playback position",
    ...
    static var previous7: String {
        String(localized: "vocello.ui.previous7", defaultValue: "Previous 7 Days",
    ...
    static var previous30: String {
        String(localized: "vocello.ui.previous30", defaultValue: "Previous 30 Days",
    ...
    static var earlier: String {
        String(localized: "vocello.ui.earlier", defaultValue: "Earlier",
    ...
    static var historySearch: String {
        String(localized: "vocello.ui.historySearch", defaultValue: "Search transcript or voice",
    ...
    static var clearKeepFiles: String {
        String(localized: "vocello.ui.clearKeepFiles", defaultValue: "Clear History (Keep Audio Files)…",
    ...
    static var clearDeleteFiles: String {
        String(localized: "vocello.ui.clearDeleteFiles", defaultValue: "Clear History and Delete Audio…",
    ...
    static var clearHistoryLower: String {
        String(localized: "vocello.ui.clearHistoryLower", defaultValue: "Clear history",
    ...
    static var historyLoadFailed: String {
        String(localized: "vocello.ui.historyLoadFailed", defaultValue: "Couldn't load history",
    ...
    static var historyLoadDetail: String {
        String(localized: "vocello.ui.historyLoadDetail", defaultValue: "Something went wrong reading your history. Tap Retry below.",
    ...
    static var noTakes: String {
        String(localized: "vocello.ui.noTakes", defaultValue: "No takes yet",
    ...
    static var noTakesDetail: String {
        String(localized: "vocello.ui.noTakesDetail", defaultValue: "Generated audio shows up here once you create a voice or line.",
    ...
    static var noMatches: String {
        String(localized: "vocello.ui.noMatches", defaultValue: "No matches",
    ...
    static var noMatchesDetail: String {
        String(localized: "vocello.ui.noMatchesDetail", defaultValue: "Nothing matches this filter or search. Try widening it.",
    ...
    static var clearDeleteQuestion: String {
        String(localized: "vocello.ui.clearDeleteQuestion", defaultValue: "Clear History and Delete Audio?",
               comment: "iOS interface: Clear History and Delete Audio?. Presentation only; never use as a model prompt or stored identity.")
    }
    static var deleteEverything: String {
        String(localized: "vocello.ui.deleteEverything", defaultValue: "Delete Everything",
    ...
    static var clearQuestion: String {
        String(localized: "vocello.ui.clearQuestion", defaultValue: "Clear History?",
               comment: "iOS interface: Clear History?. Presentation only; never use as a model prompt or stored identity.")
    }
    static var clearHistory: String {
        String(localized: "vocello.ui.clearHistory", defaultValue: "Clear History",
               comment: "iOS interface: Clear History. Presentation only; never use as a model prompt or stored identity.")
    }
    static var historyWaiting: String {
        String(localized: "vocello.ui.historyWaiting", defaultValue: "Finished audio is waiting for History",
    ...
    static var historyRecoveryProblem: String {
        String(localized: "vocello.ui.historyRecoveryProblem", defaultValue: "Vocello preserved the recovery record but could not verify or commit it. Retry before clearing History.",
    ...
    static var saveAudio: String {
        String(localized: "vocello.ui.saveAudio", defaultValue: "Save audio",
    ...
    static var deleteAudioDetail: String {
        String(localized: "vocello.ui.deleteAudioDetail", defaultValue: "This permanently removes the generated audio and its history entry.",
    ...
    static var microphoneDenied: String {
        String(localized: "vocello.ui.microphoneDenied", defaultValue: "Microphone access denied",
    ...
    static var microphoneDetail: String {
        String(localized: "vocello.ui.microphoneDetail", defaultValue: "Vocello needs the microphone to record reference clips. Enable it in Settings to continue.",
    ...
    static var recordGuidance: String {
        String(localized: "vocello.ui.recordGuidance", defaultValue: "Read 10-20 s of clean, natural speech. Quiet room. One voice.",
    ...
    static var recording: String {
        String(localized: "vocello.ui.recording", defaultValue: "Recording",
    ...
    static var captured: String {
        String(localized: "vocello.ui.captured", defaultValue: "Captured",
    ...
    static var referenceClip: String {
        String(localized: "vocello.ui.referenceClip", defaultValue: "Reference clip",
    ...
    static var recordInterrupted: String {
        String(localized: "vocello.ui.recordInterrupted", defaultValue: "Recording was interrupted. The clip up to that point was kept.",
    ...
    static var recordBegin: String {
        String(localized: "vocello.ui.recordBegin", defaultValue: "Tap Record to begin.",
    ...
    static var recordMinimum: String {
        String(localized: "vocello.ui.recordMinimum", defaultValue: "Keep recording. 10 second minimum.",
    ...
    static var recordEnough: String {
        String(localized: "vocello.ui.recordEnough", defaultValue: "Sounds good. Tap stop when ready.",
    ...
    static var recordMaximum: String {
        String(localized: "vocello.ui.recordMaximum", defaultValue: "Over 20 seconds. Stop now.",
    ...
    static var discardRecord: String {
        String(localized: "vocello.ui.discardRecord", defaultValue: "Discard and re-record",
    ...
    static var discardImport: String {
        String(localized: "vocello.ui.discardImport", defaultValue: "Discard imported voice",
    ...
    static var playRecording: String {
        String(localized: "vocello.ui.playRecording", defaultValue: "Play recording",
    ...
    static var shortClip: String {
        String(localized: "vocello.ui.shortClip", defaultValue: "A bit short",
    ...
    static var goodLength: String {
        String(localized: "vocello.ui.goodLength", defaultValue: "Good length",
    ...
    static var longClip: String {
        String(localized: "vocello.ui.longClip", defaultValue: "A bit long",
    ...
    static var voiceName: String {
        String(localized: "vocello.ui.voiceName", defaultValue: "Name",
               comment: "iOS interface: Name. Presentation only; never use as a model prompt or stored identity.")
    }
    static var nameVoice: String {
        String(localized: "vocello.ui.nameVoice", defaultValue: "Name this voice",
    ...
    static var whatYouSaid: String {
        String(localized: "vocello.ui.whatYouSaid", defaultValue: "What you said",
    ...
    static var transcriptCaption: String {
        String(localized: "vocello.ui.transcriptCaption", defaultValue: "Auto-transcribed. With it, clones carry this clip's pacing and emotion; without it, identity only.",
    ...
    static var transcriptPlaceholder: String {
        String(localized: "vocello.ui.transcriptPlaceholder", defaultValue: "What you said in the recording",
    ...
    static var saveVoice: String {
        String(localized: "vocello.ui.saveVoice", defaultValue: "Save voice",
    ...
    static var savedVoice: String {
        String(localized: "vocello.ui.savedVoice", defaultValue: "Saved voice",
    ...
    static var voicePreview: String {
        String(localized: "vocello.ui.voicePreview", defaultValue: "Voice preview",
    ...
    static var dismissClip: String {
        String(localized: "vocello.ui.dismissClip", defaultValue: "Dismiss this clip?",
    ...
    static var saveAsVoice: String {
        String(localized: "vocello.ui.saveAsVoice", defaultValue: "Save as voice",
    ...
    static var generateAgain: String {
        String(localized: "vocello.ui.generateAgain", defaultValue: "Generate again",
    ...
    static var generateAgainLabel: String {
        String(localized: "vocello.ui.generateAgainLabel", defaultValue: "Generate this take again",
    ...
    static var generateAgainHint: String {
        String(localized: "vocello.ui.generateAgainHint", defaultValue: "Starts a new generation using the visible Studio settings",
    ...
    static var streamingPreview: String {
        String(localized: "vocello.ui.streamingPreview", defaultValue: "Streaming preview",
    ...
    static var cancelGeneration: String {
        String(localized: "vocello.ui.cancelGeneration", defaultValue: "Cancel generation",
    ...
    static var preparingPreview: String {
        String(localized: "vocello.ui.preparingPreview", defaultValue: "Preparing preview",
    ...
    static var previewProgress: String {
        String(localized: "vocello.ui.previewProgress", defaultValue: "Preview playback progress",
    ...
    static var liveProgress: String {
        String(localized: "vocello.ui.liveProgress", defaultValue: "Live preview progress",
    ...
    static var clonedReference: String {
        String(localized: "vocello.ui.clonedReference", defaultValue: "Cloned reference",
    ...
    static var searchVoices: String {
        String(localized: "vocello.ui.searchVoices", defaultValue: "Search voices",
    ...
    static var yourVoices: String {
        String(localized: "vocello.ui.yourVoices", defaultValue: "Your saved voices",
    ...
    static var builtInSpeakers: String {
        String(localized: "vocello.ui.builtInSpeakers", defaultValue: "Built-in speakers",
    ...
    static var nothingMatches: String {
        String(localized: "vocello.ui.nothingMatches", defaultValue: "Nothing matches",
    ...
    static var voiceSearchDetail: String {
        String(localized: "vocello.ui.voiceSearchDetail", defaultValue: "Try a different search term or switch the filter back to All.",
    ...
    static var importFailed: String {
        String(localized: "vocello.ui.importFailed", defaultValue: "Couldn't import audio",
    ...
    static var importFailedDetail: String {
        String(localized: "vocello.ui.importFailedDetail", defaultValue: "Choose another audio file and try again.",
    ...
    static var deleteVoiceQuestion: String {
        String(localized: "vocello.ui.deleteVoiceQuestion", defaultValue: "Delete saved voice?",
    ...
    static var deleteFailed: String {
        String(localized: "vocello.ui.deleteFailed", defaultValue: "Delete failed",
    ...
    static var deleteFailedDetail: String {
        String(localized: "vocello.ui.deleteFailedDetail", defaultValue: "The saved voice was not removed. Try again.",
    ...
    static var saveNewVoice: String {
        String(localized: "vocello.ui.saveNewVoice", defaultValue: "Save a new voice",
    ...
    static var recordVoice: String {
        String(localized: "vocello.ui.recordVoice", defaultValue: "Record voice",
    ...
    static var captureDetail: String {
        String(localized: "vocello.ui.captureDetail", defaultValue: "Capture a 10-20 second reference clip on this iPhone.",
    ...
    static var stopPreview: String {
        String(localized: "vocello.ui.stopPreview", defaultValue: "Stop preview",
    ...
    static var previewVoice: String {
        String(localized: "vocello.ui.previewVoice", defaultValue: "Preview voice",
    ...
    static var deleteVoice: String {
        String(localized: "vocello.ui.deleteVoice", defaultValue: "Delete voice",
    ...
    static var waitDelete: String {
        String(localized: "vocello.ui.waitDelete", defaultValue: "Wait for generation to finish before deleting this voice.",
    ...
    static var voiceActionsHint: String {
        String(localized: "vocello.ui.voiceActionsHint", defaultValue: "Opens actions for this saved voice.",
    ...
    static var waitCurrentDelete: String {
        String(localized: "vocello.ui.waitCurrentDelete", defaultValue: "Wait for the current generation to finish before deleting this voice.",
    ...
    static var voiceBrief: String {
        String(localized: "vocello.ui.voiceBrief", defaultValue: "Voice brief",
    ...
    static var briefGuidance: String {
        String(localized: "vocello.ui.briefGuidance", defaultValue: "Describe the voice. Combine character, age, accent, and texture.",
    ...
    static var briefPlaceholder: String {
        String(localized: "vocello.ui.briefPlaceholder", defaultValue: "A warm, deep narrator with a subtle British accent.",
    ...
    static var startingPoints: String {
        String(localized: "vocello.ui.startingPoints", defaultValue: "Starting points",
    ...
    static var customTone: String {
        String(localized: "vocello.ui.customTone", defaultValue: "Custom tone",
    ...
    static var delivery: String {
        String(localized: "vocello.ui.delivery", defaultValue: "Delivery",
    ...
    static var useCustomTone: String {
        String(localized: "vocello.ui.useCustomTone", defaultValue: "Use a custom tone instead",
    ...
    static var toneGuidance: String {
        String(localized: "vocello.ui.toneGuidance", defaultValue: "Be specific: combine emotion, pace, pitch, and timbre.",
    ...
    static var recordNewClip: String {
        String(localized: "vocello.ui.recordNewClip", defaultValue: "Record new clip",
    ...
    static var deleteModelQuestion: String {
        String(localized: "vocello.ui.deleteModelQuestion", defaultValue: "Delete model?",
    ...
    static var deleteModel: String {
        String(localized: "vocello.ui.deleteModel", defaultValue: "Delete model",
               comment: "iOS interface: Delete model. Presentation only; never use as a model prompt or stored identity.")
    }
    static var neutralHint: String {
        String(localized: "vocello.ui.neutralHint", defaultValue: "Default, even pacing",
    ...
    static var happyHint: String {
        String(localized: "vocello.ui.happyHint", defaultValue: "Bright lift; can read as surprise",
    ...
    static var sadHint: String {
        String(localized: "vocello.ui.sadHint", defaultValue: "Quiet, slower, somber",
    ...
    static var angryHint: String {
        String(localized: "vocello.ui.angryHint", defaultValue: "Hard, driving push",
    ...
    static var fearfulHint: String {
        String(localized: "vocello.ui.fearfulHint", defaultValue: "Soft, unsteady; can read as sad",
    ...
    static var surprisedHint: String {
        String(localized: "vocello.ui.surprisedHint", defaultValue: "Pitch jumps, quick catches",
    ...
    static var whisperHint: String {
        String(localized: "vocello.ui.whisperHint", defaultValue: "Soft, close-mic breath",
    ...
    static var calmHint: String {
        String(localized: "vocello.ui.calmHint", defaultValue: "Slower, reassuring",
    ...
    static var builtInDetail: String {
        String(localized: "vocello.ui.builtInDetail", defaultValue: "Built-in speakers and delivery presets.",
               comment: "Onboarding built-in mode explanation.")
    }
    static var designDetail: String {
        String(localized: "vocello.ui.designDetail", defaultValue: "Describe a voice in natural language.",
               comment: "Onboarding design mode explanation, never submitted as a generation prompt.")
    }
    static var cloneDetail: String {
        String(localized: "vocello.ui.cloneDetail", defaultValue: "Use a 10-20 s reference clip you own.",
               comment: "Onboarding clone mode reference guidance.")
    }
    static var onboardingReady: String {
        String(localized: "vocello.ui.onboardingReady", defaultValue: "You're ready",
               comment: "Onboarding completion heading, not an installed-model status.")
    }
    static var onboardingReadyDetail: String {
        String(localized: "vocello.ui.onboardingReadyDetail", defaultValue: "Download a voice model in Settings, then type a script, pick a voice, generate. Your audio stays here.",
               comment: "Final onboarding page explains that model installation is still required.")
    }
    static var installFirstVoice: String {
        String(localized: "vocello.ui.installFirstVoice", defaultValue: "Install your first voice",
               comment: "First-run model installation card heading.")
    }
    static var firstVoiceDetail: String {
        String(localized: "vocello.ui.firstVoiceDetail", defaultValue: "Open Settings to download a Built-in Voice, Voice Design, or Voice Cloning model. Every package runs on-device.",
               comment: "First-run model installation card guidance.")
    }
    static var openSettings: String {
        String(localized: "vocello.ui.openSettings", defaultValue: "Open Settings",
               comment: "First-run navigation to Settings.")
    }
    static var scriptPlaceholder: String {
        String(localized: "vocello.ui.scriptPlaceholder", defaultValue: "Type or paste your script.",
               comment: "Empty Built-in composer placeholder, never actual script text.")
    }
    static var designPlaceholder: String {
        String(localized: "vocello.ui.designPlaceholder", defaultValue: "Type the lines you want this designed voice to say.",
               comment: "Empty Design composer placeholder, never actual script text.")
    }
    static var clonePlaceholder: String {
        String(localized: "vocello.ui.clonePlaceholder", defaultValue: "Type the new text. The reference voice will speak it.",
               comment: "Empty Clone composer placeholder, never actual script text.")
    }
    static var clearScript: String {
        String(localized: "vocello.ui.clearScript", defaultValue: "Clear",
               comment: "Clear the editable Studio script.")
    }
    static var generate: String {
        String(localized: "vocello.ui.generate", defaultValue: "Generate",
               comment: "Start speech generation.")
    }
    static var generating: String {
        String(localized: "vocello.ui.generating", defaultValue: "Generating",
               comment: "Active Studio generation heading.")
    }
    static var tryAgain: String {
        String(localized: "vocello.ui.tryAgain", defaultValue: "Try again.",
               comment: "Fallback Studio failure guidance.")
    }
    static var renderingAudio: String {
        String(localized: "vocello.ui.renderingAudio", defaultValue: "Rendering audio…",
               comment: "Built-in generation progress message.")
    }
    static var designingVoice: String {
        String(localized: "vocello.ui.designingVoice", defaultValue: "Designing voice…",
               comment: "Design generation progress message.")
    }
    static var cloningVoice: String {
        String(localized: "vocello.ui.cloningVoice", defaultValue: "Cloning voice…",
               comment: "Clone generation progress message.")
    }
    static var justNow: String {
        String(localized: "vocello.ui.justNow", defaultValue: "Just now",
               comment: "Relative time for the newly completed Studio take.")
    }

    static func page(_ current: Int, of total: Int) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.page", defaultValue: "Page %1$lld of %2$lld",
                   comment: "VoiceOver onboarding page position and total."), current, total)
    }

    static func installModel(_ name: String) -> String {
        String.localizedStringWithFormat(
            String(localized: "vocello.ui.installModel", defaultValue: "Install %1$@",
