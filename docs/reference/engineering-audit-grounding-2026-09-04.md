...
Repeat with a late error and delayed Clone preparation. The Design coordinator tests (retired 2026-09-15 with the coordinator; the request path is covered by the [factory tests](../../Tests/VocelloCoreTests/MacStudioGenerationRequestFactoryTests.swift))
