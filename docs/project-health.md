...
- Swift tests: 665 cases in 90 files
- Python tests: 1394 cases in 118 files
...
- Evidence routing: 900/900 critical paths explicit; 0 use repository-other fallback
...
| memory-policy | backend-platform | 6 | 7 / 58 | macos-memory-qualification: stale, ios-memory-qualification: stale |
| model-delivery | backend-platform | 17 | 8 / 76 | external promotion: macos-model-download-lifecycle, ios-model-download-lifecycle |
