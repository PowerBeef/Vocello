...
Authority: `docs/reference/ios-device-testing.md` and `docs/reference/agent-rules/native.md`. `scripts/ios_device.sh` is
...
3. Say what the verb does and how long it takes before running: `scripts/ios_device.sh <requested verb and options>`.
