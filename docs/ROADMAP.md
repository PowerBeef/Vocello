...
| `DP-31` | planned | Confirm Speed and Quality candidates with a frozen automated holdout | `file:scripts/tests/test_delivery_listening_session.py`, `file:scripts/tests/test_delivery_promotion_decision.py`, `file:scripts/tests/test_delivery_statistics.py` |
