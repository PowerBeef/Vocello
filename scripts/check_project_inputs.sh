...
REQUIRED_SURFACES=(
    ...
    "scripts/tests/test_language_bench_evidence.py"
    "scripts/tests/test_check_ios_speech_assets.py"
    "scripts/tests/test_check_language_hints.py"
    "scripts/tests/test_check_macos_xpc_bench.py"
    "scripts/tests/test_check_ios_ui_benchmark.py"
    "scripts/tests/test_check_language_output.py"
    ...
    "scripts/tests/test_prosody_holdout_validation.py"
