...
- **macOS smoke lane:** `macos-xcui-smoke-20260731-190550-a314890e` — PASS, all seven
  ...
  first→last −6.8%: flat.
- **Engine regression bench:** label `release-QA-2.3.0` — running at commit time on the
  clean release tree; the published record and its ID land in the follow-up commit that
