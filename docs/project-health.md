...
- Swift tests: 444 cases in 63 files
- Python tests: 718 cases in 58 files
- Required-step assurance: 59 steps across 13 workflows, all covered by forced-failure fixtures
