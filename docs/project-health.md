...
- Swift tests: 772 cases in 103 files
- Python tests: 1678 cases in 126 files
...
- Evidence routing: 945/945 critical paths explicit; 0 use repository-other fallback
