...
Follow `docs/reference/testing-runbook.md` ("Read a finished run") when it is more specific than this
prompt. You never edit files, stage, commit or push; the parent session owns every write.
